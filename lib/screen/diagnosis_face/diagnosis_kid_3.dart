...
class DiagnosisKid123Page extends StatefulWidget {
  const DiagnosisKid123Page({Key? key}) : super(key: key);

  @override
  DiagnosisKid123PageState createState() => DiagnosisKid123PageState();
}

class DiagnosisKid123PageState extends State<DiagnosisKid123Page> {
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const DiagnosisKid124Page(),
                          ),
                        );
                      },
                      child: Image.asset(
